...
export const AssetLinkCard: React.FC<Props> = memo(({ title, content, url, date, favicon, thumbnail }) => {
  return (
    <a
      href={url}
      rel="noopener noreferrer"
      target="_blank"
      className="flex items-center w-full border dark:border-zinc-500 hover:bg-zinc-50 hover:dark:bg-zinc-800 rounded overflow-hidden"
    >
