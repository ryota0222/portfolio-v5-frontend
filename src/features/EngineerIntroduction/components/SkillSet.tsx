    ...
    <>
      ...
      <dl className="px-6 py-4 bg-zinc-50 dark:bg-zinc-800 flex flex-col gap-4">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          {/* Next.js */}
          <dd title="Next.js">
            <svg viewBox="0 0 128 128" className="w-8 h-8" aria-label="Next.js">
              <path
          ...
          {/* Astro */}
          <dd title="Astro">
            <svg className="w-8 h-8" viewBox="0 0 256 256" aria-label="Astro">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          {/* Redux Toolkit */}
          <dd title="Redux Toolkit">
            <img
              aria-label="Redux Toolkit"
          ...
          {/* SWR */}
          <dd title="SWR">
            <svg className="w-8 h-8" viewBox="0 0 200 200" aria-label="SWR">
              <path
                fill={isDarkMode ? '#FFF' : '#000'}
          ...
          {/* React Query */}
          <dd title="React Query">
            <img
              aria-label="React Query"
              src="/images/skills/react-query.svg"
              className="w-8 h-8"
              alt="React Query"
              loading="lazy"
            />
          ...
          {/* Sentry */}
          <dd title="Sentry">
            <svg className="w-8 h-8" viewBox="0 0 512 512" aria-label="Sentry">
              <path
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          {/* Express */}
          <dd title="Express">
            <svg viewBox="0 0 128 128" className="w-8 h-8" aria-label="Express">
              <path
                fill={isDarkMode ? '#FFF' : '#000'}
          ...
          {/* Flask */}
          <dd title="Flask">
            <svg viewBox="0 0 128 128" className="w-8 h-8" aria-label="Flask">
              <path
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          {/* microCMS */}
          <dd title="microCMS">
            <svg className="w-8 h-8" viewBox="0 0 32 32" aria-label="microCMS">
              <path
