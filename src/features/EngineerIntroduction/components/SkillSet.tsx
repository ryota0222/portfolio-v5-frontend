  ...
  return (
    <>
      ...
      <dl className="px-6 py-4 bg-zinc-50 dark:bg-zinc-800 flex flex-col gap-4">
        <dt className="visibility-hidden">フロントエンド</dt>
        <div className="flex gap-4 flex-wrap">
          {/* TypeScript */}
          <dd title="TypeScript" aria-label="TypeScript">
            <img
          ...
          {/* React.js */}
          <dd title="React.js" aria-label="React.js">
            <img
          ...
          {/* Next.js */}
          <dd title="Next.js" aria-label="Next.js">
            <svg viewBox="0 0 128 128" className="w-8 h-8" role="img" aria-label="Next.js">
              <path
          ...
          {/* Vue.js */}
          <dd title="Vue.js" aria-label="Vue.js">
            <img
          ...
          {/* Nuxt.js */}
          <dd title="Nuxt.js" aria-label="Nuxt.js">
            <img
          ...
          {/* Astro */}
          <dd title="Astro" aria-label="Astro">
            <svg className="w-8 h-8" viewBox="0 0 256 256" role="img" aria-label="Astro">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M163 18.9C164.9 21.3 165.9 24.6 167.9 31.1L211.2 173.4C194.9 165 177.5 159 159.4 155.9L131.2 60.6C130.6 58.7 128.6 57.5 126.6 58.1C125.4 58.5 124.5 59.4 124.1 60.6L96.1999 155.8C78.0999 159 60.5 164.9 44.2 173.4L87.9 31.1C89.9 24.6 90.9 21.3 92.8 18.9C94.5 16.8 96.7 15.1 99.3 14.1C102.2 13 105.6 13 112.4 13H143.5C150.3 13 153.7 13 156.6 14.1C159.1 15.1 161.3 16.8 163 18.9Z"
                fill={isDarkMode ? '#FFF' : '#000'}
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M168.2 180.1C161.1 186.2 146.8 190.4 130.4 190.4C110.2 190.4 93.4001 184.1 88.9001 175.7C87.3001 180.5 86.9001 186.1 86.9001 189.6C86.9001 189.6 85.8001 207 97.9001 219C97.9001 212.7 103 207.6 109.2 207.6C119.9 207.6 119.9 217 119.9 224.6V225.3C119.9 236.5 126.6 246.6 137 250.9C135.5 247.7 134.7 244.2 134.7 240.7C134.7 229.7 141.2 225.6 148.7 220.8C154.7 217 161.3 212.8 165.9 204.4C168.4 199.8 169.6 194.8 169.6 189.6C169.7 186.3 169.1 183.1 168.2 180.1Z"
                fill="#FF5D01"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M168.2 180.1C161.1 186.2 146.8 190.4 130.4 190.4C110.2 190.4 93.4001 184.1 88.9001 175.7C87.3001 180.5 86.9001 186.1 86.9001 189.6C86.9001 189.6 85.8001 207 97.9001 219C97.9001 212.7 103 207.6 109.2 207.6C119.9 207.6 119.9 217 119.9 224.6V225.3C119.9 236.5 126.6 246.6 137 250.9C135.5 247.7 134.7 244.2 134.7 240.7C134.7 229.7 141.2 225.6 148.7 220.8C154.7 217 161.3 212.8 165.9 204.4C168.4 199.8 169.6 194.8 169.6 189.6C169.7 186.3 169.1 183.1 168.2 180.1Z"
                fill="url(#paint0_linear_145_105)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_145_105"
                  x1="164.144"
                  y1="113.196"
                  x2="121.864"
                  y2="201.686"
          ...
          {/* React Native */}
          <dd title="React Native" aria-label="React Native">
            <img src="/images/skills/react-native.svg" className="w-8 h-8" alt="React Native" loading="lazy" />
          </dd>
          {/* Redux Toolkit */}
          <dd title="Redux Toolkit" aria-label="Redux Toolkit">
            <img src="/images/skills/redux-toolkit.svg" className="w-8 h-8" alt="Redux Toolkit" loading="lazy" />
          </dd>
          {/* SWR */}
          <dd title="SWR" aria-label="SWR">
            <svg className="w-8 h-8" viewBox="0 0 200 200" role="img" aria-label="SWR">
              <path
                fill={isDarkMode ? '#FFF' : '#000'}
                d="M13 100.841C13.042 111.363 21.6349 119.979 32.1947 119.979C42.7875 119.966 51.3727 111.409 51.3895 100.847V98.1322C51.4207 92.0572 58.0366 88.2941 63.2979 91.3594C64.1068 91.8306 64.8258 92.4416 65.4213 93.1638H77.834C75.5661 84.8126 67.9704 79.0102 59.2929 79C48.6995 79.0167 40.1173 87.5766 40.1041 98.1382V100.841C40.0975 105.195 36.5554 108.721 32.1888 108.721C27.8263 108.714 24.292 105.19 24.2854 100.841C24.2854 99.5959 23.2732 98.5866 22.0247 98.5866H15.2547C14.008 98.5902 13 99.5983 13 100.841ZM86.4509 119.979C77.783 119.947 70.2035 114.148 67.9278 105.809H80.3225C84.1381 110.522 91.6397 109.35 93.8254 103.699C94.1774 102.789 94.3567 101.822 94.3543 100.847V98.1322C94.3705 87.5706 102.956 79.0132 113.549 79C124.001 79 132.522 87.3704 132.738 97.7317L132.798 100.841C132.829 106.916 139.445 110.679 144.706 107.614C145.515 107.143 146.234 106.531 146.83 105.809H159.242C156.977 114.161 149.384 119.966 140.707 119.979C130.147 119.979 121.554 111.357 121.512 100.847L121.452 98.0366V97.917C121.326 93.6547 117.826 90.2629 113.549 90.2581C109.187 90.2647 105.652 93.7892 105.646 98.1382V100.841C105.632 111.405 97.0461 119.966 86.4509 119.979ZM161.677 93.1698C165.492 88.4573 172.994 89.6298 175.18 95.2809C175.532 96.1927 175.712 97.1613 175.709 98.1382C175.709 99.3836 176.721 100.392 177.969 100.392H184.745C185.991 100.389 187 99.3812 187 98.1382C186.987 87.5742 178.4 79.0132 167.805 79C159.126 79.0108 151.529 84.8162 149.264 93.1698H161.677Z"
              />
            </svg>
          </dd>
          {/* React Query */}
          <dd title="React Query" aria-label="React Query">
            <img src="/images/skills/react-query.svg" className="w-8 h-8" alt="React Query" loading="lazy" />
          </dd>
          {/* Storybook */}
          <dd title="Storybook" aria-label="Storybook">
            <img
          ...
          {/* Sentry */}
          <dd title="Sentry" aria-label="Sentry">
            <svg className="w-8 h-8" viewBox="0 0 512 512" role="img" aria-label="Sentry">
              <path
                d="M248.638 69.2247L199.278 154.52C311.192 228.826 377.405 357.547 369.078 483.998H244.312C247.983 395.843 212.812 315.039 137.126 261.713L111.99 305.462C166.718 344.071 198.878 409.553 194.713 483.721L44.539 483.697C5.2633 480.766 -9.40019 443.829 6.02874 414.457L36.2645 361.904L68.6912 380.562L38.7009 432.683C35.949 439.101 36.9512 445.501 46.0478 446.309H156.024C148.778 391.897 119.932 349.028 61.4031 318.411L123.775 209.852C226.043 262.936 277.396 361.735 281.077 446.587H331.098C324.361 327.997 256.464 226.095 148.33 167.865L217.112 49.0091C236.648 21.6131 275.721 20.3107 294.915 49.25L506.217 414.984C524.018 449.768 498.185 483.59 463.311 483.721H416.678V446.309L464.365 446.323C472.557 446.486 477.221 440.835 473.104 432.404L263.291 69.247C259.565 64.3346 252.696 64.0818 248.638 69.2247Z"
                fill={isDarkMode ? '#FFF' : '#000'}
              />
            </svg>
          </dd>
        ...
        <dt className="visibility-hidden">バックエンド</dt>
        <div className="flex gap-4 flex-wrap">
          {/* Node.js */}
          <dd title="Node.js" aria-label="Node.js">
            <img
          ...
          {/* Express */}
          <dd title="Express" aria-label="Express">
            <svg viewBox="0 0 128 128" className="w-8 h-8" role="img" aria-label="Express">
              <path
                fill={isDarkMode ? '#FFF' : '#000'}
          ...
          {/* Nest.js */}
          <dd title="Nest.js" aria-label="Nest.js">
            <img
          ...
          {/* Python */}
          <dd title="Python" aria-label="Python">
            <img
          ...
          {/* Flask */}
          <dd title="Flask" aria-label="Flask">
            <svg viewBox="0 0 128 128" className="w-8 h-8" role="img" aria-label="Flask">
              <path
                fill={isDarkMode ? '#FFF' : '#010101'}
        ...
        <dt className="visibility-hidden">その他</dt>
        <div className="flex gap-4 flex-wrap">
          {/* Firebase */}
          <dd title="Firebase" aria-label="Firebase">
            <img src="/images/skills/firebase.svg" className="w-8 h-8" alt="Firebase" loading="lazy" />
          </dd>
          {/* Supabase */}
          <dd title="Supabase" aria-label="Supabase">
            <img src="/images/skills/supabase.svg" className="w-8 h-8" alt="Supabase" loading="lazy" />
          </dd>
          {/* Contentful */}
          <dd title="Contentful" aria-label="Contentful">
            <img src="/images/skills/contentful.svg" className="w-8 h-8" alt="Contentful" loading="lazy" />
          </dd>
          {/* microCMS */}
          <dd title="microCMS" aria-label="microCMS">
            <svg className="w-8 h-8" viewBox="0 0 32 32" role="img" aria-label="microCMS">
              <path
                fill={isDarkMode ? '#FFF' : '#2B2C30'}
                fillRule="evenodd"
                clipRule="evenodd"
                d="M28 0H4C2 0 0 2 0 4V28C0 30.2092 1.79086 32 4 32H28C30.2092 32 32 30.2092 32 28V4C32 1.79086 30.2092 0 28 0ZM23.4334 12.5195L22.302 11.3882L20.0392 13.6509L21.1706 14.7823L23.4334 12.5195ZM19.332 9.83258C19.7225 9.44206 20.3556 9.44206 20.7462 9.83258L22.302 11.3882L10.9881 22.702L8.72538 20.4392L19.332 9.83258ZM14.8066 5.3072C15.1971 4.91668 15.8303 4.91668 16.2208 5.3072L17.7765 6.86284L18.9076 7.99414L16.6449 10.2569L15.5136 9.12566L8.7255 15.9138L9.85682 17.0451L7.59408 19.3079L6.46276 18.1765L4.90712 16.6209C4.51658 16.2304 4.51658 15.5972 4.90712 15.2067L14.8066 5.3072ZM26.8274 15.9137L27.9588 17.0451L25.696 19.3079L24.5646 18.1765L26.8274 15.9137ZM13.2508 24.9646L12.1197 23.8334L14.3825 21.5706L15.5136 22.7018L23.8574 14.358C24.2478 13.9674 24.881 13.9674 25.2716 14.358L26.8274 15.9137L16.2206 26.5202C15.8301 26.9108 15.1969 26.9108 14.8064 26.5202L13.2508 24.9646Z"
              />
            </svg>
          </dd>
          {/* Figma */}
          <dd title="Figma" aria-label="Figma">
            <img
          ...
          {/* XD */}
          <dd title="Adobe XD" aria-label="Adobe XD">
            <img
