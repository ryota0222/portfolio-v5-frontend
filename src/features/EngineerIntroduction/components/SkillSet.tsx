...
export const SkillSet = memo(() => {
  ...
  return (
    <dl className="px-6 py-4 bg-zinc-50 dark:bg-zinc-800 flex flex-col gap-4">
      ...
      <dt className="invisible h-0">フロントエンド</dt>
      <div className="flex gap-4 flex-wrap">
        {/* TypeScript */}
        <dd aria-label="TypeScript" title="TypeScript">
          <img
        ...
        {/* React.js */}
        <dd aria-label="React.js" title="React.js">
          <img
        ...
        {/* Next.js */}
        <dd aria-label="Next.js" title="Next.js">
        ...
        {/* Vue.js */}
        <dd aria-label="Vue.js" title="Vue.js">
          <img
        ...
        {/* Nuxt.js */}
        <dd aria-label="Nuxt.js" title="Nuxt.js">
          <img
        ...
        {/* Astro */}
        <dd aria-label="Astro" title="Astro">
        ...
        {/* Sentry */}
        <dd aria-label="Sentry" title="Sentry">
      ...
      <dt className="invisible h-0">バックエンド</dt>
      <div className="flex gap-4 flex-wrap">
        {/* Node.js */}
        <dd aria-label="Node.js" title="Node.js">
          <img
        ...
        {/* Express */}
        <dd aria-label="Express" title="Express">
          <svg viewBox="0 0 128 128" className="w-8 h-8">
            <path
              fill={isDarkMode ? '#FFF' : '#000'}
        ...
        {/* Nest.js */}
        <dd aria-label="Nest.js" title="Nest.js">
          <img
        ...
        {/* Python */}
        <dd aria-label="Python" title="Python">
          <img
        ...
        {/* Flask */}
        <dd aria-label="Flask" title="Flask">
          <svg viewBox="0 0 128 128" className="w-8 h-8">
            <path
      ...
      <dt className="invisible h-0">その他</dt>
      <div className="flex gap-4 flex-wrap">
        {/* Firebase */}
        ...
        {/* Figma */}
        <dd aria-label="Figma" title="Figma">
          <img
